 ...
 */
final class Version20211003143514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE todo ADD owner_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE todo DROP owner_id');
    }
}
